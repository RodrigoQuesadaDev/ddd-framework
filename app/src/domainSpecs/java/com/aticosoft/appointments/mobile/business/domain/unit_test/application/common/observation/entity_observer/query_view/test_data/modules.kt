...
internal class TestDataGrandChildModule : EntityModule<TestDataGrandChild,
        EntityValidator<TestDataGrandChild, *>,
        EntityInitializer<TestDataGrandChild>,
        EntityListener<TestDataGrandChild>> {

    @Provides @Singleton
    override fun provideEntityType(): Class<TestDataGrandChild> = TestDataGrandChild::class.java

    @Provides @IntoSet
    override fun provideEntityTypeIntoSet(): Class<out Entity> = provideEntityType()

    @Provides @IntoSet
    override fun provideEntityInitializerIntoSet(initializer: EntityInitializer<TestDataGrandChild>): EntityInitializer<*> = initializer

    @Provides @IntoSet
    override fun provideEntityListenerIntoSet(listener: EntityListener<TestDataGrandChild>): EntityListener<*> = listener
}