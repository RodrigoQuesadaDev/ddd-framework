 ...
 */
@Singleton
internal class OddValueAndEmailParentQueries @Inject constructor(private val context: PersistenceContext) {

    fun first() = UniqueQuery { context.queryFactory.selectFrom(QOddValueAndEmailParent.oddValueAndEmailParent).fetchFirst() }
}

@Singleton
internal class PrimeNumberAndGmailParentQueries @Inject constructor(private val context: PersistenceContext) {
