...
internal class TestQueryViewsModule : QueryViewsModule() {
    ...
    override fun provideQueryViews(): Array<Class<out Enum<*>>> = arrayOf(
            com.aticosoft.appointments.mobile.business.domain.unit_test.application.common.observation.entity_observer.filtering.test_data.TestDataParentQueryView::class.java,
