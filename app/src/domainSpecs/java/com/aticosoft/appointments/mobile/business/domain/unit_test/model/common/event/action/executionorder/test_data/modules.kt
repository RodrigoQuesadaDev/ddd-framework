 ...
 */
@Module
internal class NoActionsEventModule : TestEventModule<NoActionsEvent>() {
...
@Module
internal class ThreeActionsEventModule : TestEventModule<ThreeActionsEvent>() {
    ...
    fun provideEventActionsIntoSet(
            eventAction1: ThreeActionsEventAction1,
            eventAction2: ThreeActionsEventAction2,
            eventAction3: ThreeActionsEventAction3
    ): Set<EventAction<*>> {
...
@Module
internal class FiveActionsEventModule : TestEventModule<FiveActionsEvent>() {
    ...
    @Provides @ElementsIntoSet
    fun provideEventActionsIntoSet(
            eventAction1: FiveActionsEventAction1,
            eventAction2: FiveActionsEventAction2,
            eventAction3: FiveActionsEventAction3,
            eventAction4: FiveActionsEventAction4,
            eventAction5: FiveActionsEventAction5
    ): Set<EventAction<*>> {
