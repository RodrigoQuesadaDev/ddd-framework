...
import com.aticosoft.appointments.mobile.business.domain.specs.use_cases.appointment.scheduling.constrains.TimeSlotsAlignment.SpecApplicationImpl
...
internal class TimeSlotsAlignment : AppointmentStory() {
    ...
    class SpecApplicationImpl : SpecApplication<TimeSlotsAlignment>(SpecApplicationComponent::inject)
    ...
    class LocalSteps @Inject protected constructor(
        ...
        fun thenTheSystemThrowsATimeSlotValidationExceptionIndicatingTheScheduleTimeDoesntComplyWithTheTimeSlotConfiguration() {
            assertThat(throwable).isInstanceOf(TimeSlotValidationException::class.java)
        }
    }
}