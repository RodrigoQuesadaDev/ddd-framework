 ...
 */
internal inline fun <reified R : TestEventAction<*>> Class<out Event>.declaredActions(): Sequence<R> {
    val actionClass = R::class.java

    return createReflectionsForPackages(actionClass.`package`)
            .getSubTypesOf(actionClass).asSequence()
