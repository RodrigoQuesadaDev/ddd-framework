...
@Singleton
internal class BadCondModifiesEventServices @Inject protected constructor(
        private val testEventFactory: BadCondModifiesEventFactory
) : TestEventServices<BadCondModifiesEvent>({ testEventFactory.create(it) })

@Singleton
internal class BadCondAddedAfterInitEventServices @Inject protected constructor(
        private val testEventFactory: BadCondAddedAfterInitEventFactory
) : TestEventServices<BadCondAddedAfterInitEvent>({ testEventFactory.create(it) })