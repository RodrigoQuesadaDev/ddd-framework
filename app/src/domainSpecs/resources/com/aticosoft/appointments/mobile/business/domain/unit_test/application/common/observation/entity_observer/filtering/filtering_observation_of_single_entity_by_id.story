...
In order to filter the observation of a single entity by its id
As a developer
...
| ODD_CHILD                        | [{p:3, c:3}, {p:3, c:3}, {p:3, c:3}, {p:3, c:33}, {p:23, c:34}, {p:24, c:34}, {p:24, c:35}, null] |
| ODD_CHILD_REMOVED                | [{p:3, c:3}, {p:3, c:3}, null]                                                                    |
| ODD_AND_DIVISIBLE_BY_THREE_CHILD | [{p:3, c:3}, {p:3, c:3}, {p:3, c:3}, {p:3, c:33}, {p:23, c:34}, {p:24, c:34}]                     |