...
In order to filter the observation of a unique query
As a developer
...
Examples:
| filter                           | result                                                                          |
| PARENT_WITH_VALUE                | [null, {p:3, c:3}, null, {p:3, c:35}, null]                                     |
| EVEN_PARENT                      | [null, {p:3, c:3}, {p:3, c:3}, null, null, null, {p:3, c:35}]                   |
| ODD_CHILD                        | [null, {p:3, c:3}, {p:3, c:3}, {p:3, c:3}, {p:3, c:33}, null, null, null, null] |
| ODD_CHILD_REMOVED                | [null, {p:3, c:3}, null]                                                        |
| ODD_AND_DIVISIBLE_BY_THREE_CHILD | [null, {p:3, c:3}, {p:3, c:3}, {p:3, c:3}, {p:3, c:33}, null, null]             |