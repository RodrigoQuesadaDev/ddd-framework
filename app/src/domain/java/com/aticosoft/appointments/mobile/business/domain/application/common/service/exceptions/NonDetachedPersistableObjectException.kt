 ...
 */
/*internal*/ class NonDetachedPersistableObjectException(obj: PersistableObject<*>) : RuntimeException("Persistable object is not detached: ${PersistableObjectInfo(obj)}")